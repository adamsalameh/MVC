...
<div class="container-fluid">
  ...
  <!-- Page Content -->
      ...
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/dashboard/updatePost/<?php echo $data['post']->getId(); ?>" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="title" class="form-control" id="exampleFormControlInput1" value="<?php echo $data['post']->getTitle(); ?>">
  </div>
    ...
    <textarea name="body" class="form-control" id="exampleFormControlTextarea1" rows="3" ><?php echo htmlspecialchars($data['post']->getBody()); ?></textarea>
  </div>
